...
export class RfqmTransactionSubmissionEntity {
    ...
    @Column({ name: 'max_gas_price', type: 'numeric', nullable: true, transformer: BigNumberTransformer })
    public maxFeePerGas: BigNumber | null;

    @Column({ name: 'max_priority_fee', type: 'numeric', nullable: true, transformer: BigNumberTransformer })
